#!/usr/bin/env python3
"""
Pull configuration from Moku device (progressive introspection).
...
Usage:
    python scripts/pull.py <device-ip> [--level 1|2|3] [--force] [--non-interactive] [--output FILE]
    # Default: writes to ./curr_model.json
    # Use --output - to write to stdout

Examples:
    python scripts/pull.py 192.168.1.100                    # Basic read
    python scripts/pull.py 192.168.1.100 --level 2          # Detailed settings
    python scripts/pull.py 192.168.1.100 --level 3 --force  # Maximum detail
"""
...
Examples:
  ...
  python scripts/pull.py 192.168.13.147

  # Detailed read to specific file
  python scripts/pull.py 192.168.13.147 --level 2 --output my_config.json

  # Force connect and read everything
  python scripts/pull.py 192.168.13.147 --level 3 --force

  # Write to stdout (for piping)
  python scripts/pull.py 192.168.13.147 --output -
        """
    )
